...
img2[:, :, 1] = img[:, :, 1]
img2[:, :, 2] = img[:, :, 0]
cv2.imwrite("result_blue_to_gold.png", img2)

# change blue to green
img2[:, :, 0] = (img[:, :, 0] + 255) / 2
img2[:, :, 1] = img[:, :, 1]
img2[:, :, 2] = img[:, :, 2] / 2
cv2.imwrite("result_blue_to_green.png", img2)

# change blue to purple
img2[:, :, 0] = img[:, :, 1]
img2[:, :, 1] = img[:, :, 2]
img2[:, :, 2] = (img[:, :, 0] + 255) / 2
cv2.imwrite("result_blue_to_purple.png", img2)

# change blue to purple
img2[:, :, 0] = img[:, :, 1]
img2[:, :, 1] = img[:, :, 1]
img2[:, :, 2] = img[:, :, 0]
cv2.imwrite("result_blue_to_red.png", img2)

# change purple to red
img = cv2.imread("pallet2.png")
img = img.astype(np.uint8)
img2 = np.zeros((img.shape[0], img.shape[1], 3))
...
img2[:, :, 1] = img[:, :, 1]
img2[:, :, 2] = img[:, :, 0] * 2
cv2.imwrite("result_purple_to_red.png", img2)

# change purple to gray
img2[:, :, 0] = img[:, :, 0]
img2[:, :, 1] = img[:, :, 2]
img2[:, :, 2] = img[:, :, 1]
cv2.imwrite("result_purple_to_gray.png", img2)

# change purple to green
img2[:, :, 0] = img[:, :, 2]
img2[:, :, 1] = img[:, :, 1] * 2 - 255
img2[:, :, 2] = img[:, :, 0]
cv2.imwrite("result_purple_to_green.png", img2)

# change purple to gold
img2[:, :, 0] = img[:, :, 1]
img2[:, :, 1] = img[:, :, 2] + 40
img2[:, :, 2] = img[:, :, 0] + 40
cv2.imwrite("result_purple_to_gold.png", img2)
